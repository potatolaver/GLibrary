...
public class SwipeBackLayout extends FrameLayout {
    ...
    public void attachToActivity(Activity activity) {
        ...
        mDecorChild = (ViewGroup) decor.getChildAt(0);
//        mDecorChild.setBackgroundResource(R.drawable.background_swipe_back);
        ...
        decor.removeView(mDecorChild);
        addView(mDecorChild);
        setContentView(mDecorChild);
        decor.addView(this);
    }

    private ViewGroup mDecorChild;

    public void setDecorChildBackground(int resId) {
        mDecorChild.setBackgroundResource(resId);
    }
